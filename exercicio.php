<?php 
	...
	echo("Insira a Operação desejada: <br/>");
 	...
 	echo ("A soma de $num1 mais $num2 é: $resp <br/>");
 	echo ("A subtração de $num1 mais $num2 é: $resp1 <br/>");
 	echo ("A multiplicação de $num1 mais $num2 é: $resp2 <br/>");
 	echo ("A divisão de $num1 mais $num2 é: $resp3 <br/>");
 	echo ("O resto da divisão de $num1 mais $num2 é: $resp4 <br/>");
 ?>